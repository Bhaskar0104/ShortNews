package com.example.shortnews.ui.components
...
import com.example.shortnews.data.entity.ArticlesItem
import com.example.shortnews.data.entity.NewsResponse
import com.example.shortnews.ui.theme.Purple40
...
@Composable
fun NewsRowsComponent(page: Int, article: ArticlesItem) {
    Column(
        modifier = Modifier
            .fillMaxSize()
            .padding(8.dp)
        ...
        AsyncImage(
            ...
            onError = {
                Log.d("ArticleImage", "NewsRowsComponent: ${it.result.throwable.message}")
            }
        )
...
fun EmptyStateComponent() {
    Column(
        ...
        Image(
            painter = painterResource(R.drawable.news_no_data),
            contentDescription = null
        )

        HeadingTextComponent(
            stringResource(R.string.no_news_of_now_please_check_in_some_time),
            centerAligned = true
        )
    }
}